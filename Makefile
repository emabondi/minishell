...
#    Updated: 2022/11/30 17:18:41 by ebondi           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJS = minishell.c command.c pipes.c expand_env.c expand_env2.c ft_parser.c export.c utils.c smart_split.c builtins.c exit.c external_command.c unset.c export2.c cd.c quotes.c redirection.c
LIBFT = libft/libft.a 
