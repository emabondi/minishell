...
#    Updated: 2022/12/01 20:14:23 by ebondi           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJS = minishell.c command.c pipes.c expand_env.c expand_env2.c ft_parser.c ft_parser2.c export.c utils.c smart_split.c builtins.c exit.c external_command.c unset.c export2.c cd.c quotes.c redirection.c
LIBFT = libft/libft.a 
