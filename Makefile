...
#    Updated: 2022/11/08 11:22:32 by ebondi           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJS = minishell.c command.c expand_env.c expand_env2.c ft_parser.c export.c utils.c smart_split.c builtins.c external_command.c unset.c export2.c cd.c
LIBFT = libft/libft.a
